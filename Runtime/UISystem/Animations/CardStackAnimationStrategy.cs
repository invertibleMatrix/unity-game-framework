...
namespace AK.Systems.Animations
{
    ...
    public class CardStackAnimationStrategy : AnimationStrategy
    {
        ...
        [ShowIf("_randomizeSpacing")] [SerializeField] [Tooltip("Random spacing amount")]
        ...
        [ShowIf("_addRotation")] [SerializeField] [Tooltip("Max rotation per card")]
        private float _maxRotation = 5f;
        
        [ShowIf("_addRotation")] [SerializeField] [Tooltip("Randomize rotation")]
