...
namespace AK.Systems.Animations
{
    ...
    public class DropBounceAnimationStrategy : AnimationStrategy
    {
        ...
        [SerializeField] [Tooltip("Squash amount on impact")]
        private Vector3 _squashAmount = new Vector3(1.3f, 0.7f, 1f);
        
        [SerializeField] [Tooltip("Stretch amount in air")]
        ...
        [SerializeField] [Tooltip("Random rotation direction")]
        ...
        [SerializeField] [Tooltip("Fall distance")]
