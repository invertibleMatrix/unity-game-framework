...
namespace AK.Systems.Animations
{
    ...
    public class SlideRotateAnimationStrategy : AnimationStrategy
    {
        ...
        [SerializeField] [Tooltip("Anticipation distance")]
