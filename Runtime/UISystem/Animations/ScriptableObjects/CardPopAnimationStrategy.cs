...
namespace AK.Systems.Animations
{
    ...
    public class CardPopAnimationStrategy : AnimationStrategy
    {
        ...
        [SerializeField] [Tooltip("Movement distance")]
        private float _movementDistance = 30f;
        
        [SerializeField] [Tooltip("Movement direction")]
        ...
        [SerializeField] [Tooltip("Randomize rotation direction")]
        ...
        [SerializeField] [Tooltip("Wobble duration")]
