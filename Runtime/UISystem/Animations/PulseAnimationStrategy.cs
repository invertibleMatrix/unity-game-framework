...
namespace AK.UISystem.Animations
{
    ...
    public class PulseAnimationStrategy : AnimationStrategy
    {
        ...
        [SerializeField] [ShowIf("_addRotationPulse")] [Tooltip("Rotation amount")]
        ...
        [SerializeField] [ShowIf("_continuousPulse")] [Tooltip("Continuous pulse speed")]
        private float _continuousSpeed = 1f;
        
        [SerializeField] [ShowIf("_continuousPulse")] [Tooltip("Continuous pulse intensity")]
