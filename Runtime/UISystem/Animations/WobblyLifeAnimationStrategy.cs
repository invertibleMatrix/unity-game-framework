...
namespace AK.Systems.Animations
{
    ...
    public class WobblyLifeAnimationStrategy : AnimationStrategy
    {
        ...
        [SerializeField] [ShowIf("_addNervousTwitches")] [Tooltip("Twitch frequency")]
        private float _twitchFrequency = 2.5f;
        
        [SerializeField] [Tooltip("Add idle dancing")]
        private bool _addIdleDancing = true;
        
        [SerializeField] [ShowIf("_addIdleDancing")] [Tooltip("Dance style")]
        ...
        [SerializeField] [ShowIf("_addEmotionalReactions")] [Tooltip("Excitement level")]
        ...
        [SerializeField] [ShowIf("_addJigglePhysics")] [Tooltip("Jiggle amount")]
        private float _jiggleAmount = 5f;
        
        [SerializeField] [Tooltip("Add stretch and squash")]
        private bool _addStretchSquash = true;
        
        [SerializeField] [ShowIf("_addStretchSquash")] [Tooltip("Squash sensitivity")]
        ...
        [SerializeField] [ShowIf("_addLifeSounds")] [Tooltip("Sound frequency")]
