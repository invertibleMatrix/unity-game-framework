...
namespace GameplayCore.Models
{
	...
	public class GameModel : EntityModel, ISerializationCallbackReceiver
	{
		...
		[NonSerialized] private Dictionary<TransactionType, List<Transaction>> _transactionCollection;
		...
		/// <summary>
		/// Fallback reward application. Provider-based dispatch is handled by RewardService.
		/// </summary>
